package com.bumbumapps.vectorpinball.model;
...
import com.bumbumapps.vectorpinball.elements.FlipperElement;
    ...
    public static Delegate createDelegateFromLayoutClass(Field field) {
        ...
        if (delegateClass != null) {
            if (delegateClass.indexOf('.') == -1) {
                delegateClass = "com.bumbumapps.vectorpinball.fields." + delegateClass;
            }
            try {
