package com.bumbumapps.vectorpinball.elements;
...
import com.bumbumapps.vectorpinball.model.IDrawable;
import com.bumbumapps.vectorpinball.model.IFieldRenderer;
import com.bumbumapps.vectorpinball.model.WorldLayers;
...
public abstract class FieldElement implements IDrawable {
    ...
    public static FieldElement createFromParameters(
        ...
        if (className.indexOf('.') == -1) {
            className = "com.bumbumapps.vectorpinball.elements." + className;
        }
        try {
